...
public class @GameControls : IInputActionCollection, IDisposable
{
    ...
    ""maps"": [
        {
            ""name"": ""Gameplay"",
            ""id"": ""f19e0d75-5adf-488c-b8de-a06357a1ce73"",
            ""actions"": [
                {
                    ""name"": ""Moviment"",
                    ""type"": ""Value"",
                    ""id"": ""82ea66eb-b784-4e74-80a9-028bbbff6ff4"",
            ...
            ""bindings"": [
                {
                    ""name"": ""Arrows"",
                    ""id"": ""6cc3df08-2add-4c6e-923a-b2bced6d781e"",
                    ""path"": ""2DVector"",
                    ""interactions"": """",
                    ""processors"": """",
                    ""groups"": """",
                ...
                {
                    ""name"": ""up"",
                    ""id"": ""7880a95a-d4be-4193-a564-16b749102a58"",
                ...
                {
                    ""name"": ""down"",
                    ""id"": ""392f15f0-1f23-4fcd-86c8-e24b26e5aa37"",
                ...
                {
                    ""name"": ""left"",
                    ""id"": ""1539d521-d5da-4694-915e-df4a50d8d364"",
                ...
                {
                    ""name"": ""right"",
                    ""id"": ""4c4c32f8-5349-465e-9560-d92eb3c8e4af"",
                ...
                {
                    ""name"": ""WASD"",
                    ""id"": ""272ba533-523d-4c01-b56c-06ae8653ac92"",
                    ""path"": ""2DVector"",
                    ""interactions"": """",
                    ""processors"": """",
                    ""groups"": """",
                ...
                {
                    ""name"": ""up"",
                    ""id"": ""ae4e8e16-4636-40f3-869f-27cade77e3d9"",
                    ""path"": ""<Keyboard>/w"",
                    ""interactions"": """",
                    ""processors"": """",
                    ""groups"": ""Keyboard"",
                ...
                {
                    ""name"": ""down"",
                    ""id"": ""112da636-986f-476b-b956-fa85f1f16590"",
                    ""path"": ""<Keyboard>/s"",
                    ""interactions"": """",
                    ""processors"": """",
                    ""groups"": ""Keyboard"",
                ...
                {
                    ""name"": ""left"",
                    ""id"": ""305f5ed3-2f96-4328-8d21-3dc492a002e6"",
                    ""path"": ""<Keyboard>/a"",
                    ""interactions"": """",
                    ""processors"": """",
                    ""groups"": ""Keyboard"",
                ...
                {
                    ""name"": ""right"",
                    ""id"": ""de0dcdf8-015f-4eee-91d9-d78885d98a65"",
                    ""path"": ""<Keyboard>/d"",
                    ""interactions"": """",
                    ""processors"": """",
                    ""groups"": ""Keyboard"",
                ...
                {
                    ""name"": """",
                    ""id"": ""9a82ba78-bb5e-4bd5-ba2f-95a397dddca7"",
